...
# Calculates the ionic abundances for each distance from the central star or the center of the nebula
...
def ionicabundances(obs,obs_fake,Te,Te_error,Te_fake,Ne,Ne_error,Ne_fake,i,ang,line_names,lines_available,ion_abun,ion_abun_error,param_estimated,param_requered,param_mod_name):
    ...
    print("################################", file=file10)        
    print("################################", file=file10)    
    print("ionic abundances radial distribution", file=file10)
#############################################################
    He1 = pn.RecAtom('He',1)
