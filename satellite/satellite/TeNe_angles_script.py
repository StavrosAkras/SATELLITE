...
def TeNe(flux_angles,flux_angles_error,ang,line_names,lines_available,param_estimated,param_requered,param_mod_name,param_model_values,par_plotname,par_plotymin,par_plotymax):
    ...
    print >>file6, "ang",'He      ', 'N_KB    ','ICF(N)_KB','N_DI    ','ICF(N)_DI', 'O_KB    ','ICF(O)_KB', 'O_DI    ','ICF(O)_DI','S_KB    ', 'ICF(S)_KB','S_DI    ','ICF(S)_DI','Ne_KB  ','ICF(Ne)_KB','Ne_DI  ','ICF(Ne)_DI','Cl_KB  ','ICF(Cl)_KB','Cl_DI  ','ICF(Cl)_DI','Ar_KB ','ICF(Ar)_KB','Ar_DI   ','ICF(Ar)_DI        ','NO_ratio_KB','NO_ratio_DIMS','SO_ratio_KB','SO_ratio_DIMS','NeO_ratio_KB','NeO_ratio_DIMS','ClO_ratio_KB','ClO_ratio_DIMS','ArO_ratio_KB','ArO_ratio_DIMS'      
    
    file5 = open('PyNeb_output_ionic_abund_per_angles.txt','w')
    print >>file5, "ang",'He+(5876)','He+(6678)','He++(4686)','He++(5412)','N0(5199)','N+(5755)','N+(6548)','N+(6584)','O0(5577)','O0(6300)','O0(6363)','O+(3727)','O+(3729)','O+(7320)','O+(7330)','O+++(4363)','O+++(4959)','O+++(5007)','S+(6716)  ','S+(6731)','S++(6312)','S++(9069)','Ne++(3868)','Ne++(3968)','Cl++(5518)', 'Cl++(5538)','Ar++(7136)','Ar+++(4712)', 'Ar+++(4740)'  

    
    file4 = open('PyNeb_output_Te_and_Ne_per_angles.txt','w')
    print >>file4, "ang","Te_NII","Ne_SII ","Te_OI","Ne_SII","Te_OII","Ne_SII","Te_OIII","Ne_SII","Te_SIII","Ne_SII","Te_OII","Ne_OII","Te_NII","Ne_OII","Te_OI ","Ne_OII","Te_OIII","Ne_ClIII","Te_SIII","Ne_ClIII","Te_OIII","Ne_ArVI","Te_SIII","Ne_ArVI","Te_NII","Ne_ClIII"
    ...
    for i in range(0,len(ang)):
        ...
        print >>file4, "######################################"," slit PA  ", ang[i] ," ##############################"
        print >>file5, "######################################"," slit PA  ", ang[i] ," ##############################"
        print >>file6, "######################################"," slit PA  ", ang[i] ," ##############################"
...
#        plt.show()
        ...
        if (index_Te_NII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (NII-SII): Te_NII  = {0:5.0f}, Ne_SII = {1:7.1f}  cm-1'.format(Te.NIISII[i], Ne.NIISII[i])," angle=",ang[i]
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OI-SII): Te_OI  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OISII[i],Ne.OISII[i])," angle=",ang[i] 
        ...
        if (index_Te_OII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OII-SII): Te_OII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIISII[i], Ne.OIISII[i])," angle=",ang[i]
        ...
        if (index_Te_OIII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-SII): Te_OIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIIISII[i], Ne.OIIISII[i])," angle=",ang[i]
        ...
        if (index_Te_SIII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-SII): Te_SIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.SIIISII[i], Ne.SIIISII[i])," angle=",ang[i]  
        ...
        if (index_Te_OII=="yes" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OII-OII): Te_OII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIIOII[i], Ne.OIIOII[i])," angle=",ang[i]
        ...
        if (index_Te_NII=="yes" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (NII-OII): Te_NII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.NIIOII[i],Ne.NIIOII[i])," angle=",ang[i]
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OI-OII): Te_OI  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIOII[i], Ne.OIOII[i])," angle=",ang[i]
        ...
        if (index_Te_OIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-ClIII): Te_OIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.OIIIClIII[i],Ne.OIIIClIII[i])," angle=",ang[i]          
        ...
        if (index_Te_SIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-ClIII): Te_SIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.SIIIClIII[i], Ne.SIIIClIII[i])," angle=",ang[i]
        ...
        if (index_Te_OIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-ArVI): Te_OIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.OIIIArVI[i], Ne.OIIIArVI[i])," angle=",ang[i]          
        ...
        if (index_Te_SIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-ArVI): Te_SIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.SIIIArVI[i],Ne.SIIIArVI[i])," angle=",ang[i]
