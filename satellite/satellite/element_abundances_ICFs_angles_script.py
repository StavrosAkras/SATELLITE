# element_abundances_ICFs_angles_script.py:
            ...
            if (O2_ab!=0 or O3_ab!=0): 
                if (Cl3_ab!=0 and Cl2_ab==0 and Cl4_ab==0 ):
                    if ((He3_ab/(He2_ab+He3_ab))>0.02 and (He3_ab/(He2_ab+He3_ab))<0.95):
                        elem_abun_DIMS.Cl[i]= icf.getElemAbundance(atom_abun, icf_list=['DIMS14_12','DIMS14_29']).get("DIMS14_29") # Computes the Cl abundance 
                        abunda = icf.getElemAbundance(atom_abun_fake, icf_list=['DIMS14_12','DIMS14_29']).get("DIMS14_29") # Computes the Cl abundance 
                        abunda[abunda == inf] =  0
                        abunda=np.nan_to_num(abunda)
                        abunda = [i2 for i2 in abunda if i2 != 0]
                ...
                if (Cl3_ab!=0 and Cl2_ab!=0 and Cl4_ab==0):
                    if ((He3_ab/(He2_ab+He3_ab))<=0.02):
                        elem_abun_DIMS.Cl[i]= icf.getElemAbundance(atom_abun, icf_list=['DIMS14_12','DIMS14_29b']).get("DIMS14_29b") # Computes the Cl abundance
                        abunda = icf.getElemAbundance(atom_abun_fake, icf_list=['DIMS14_12','DIMS14_29b']).get("DIMS14_29b") # Computes the Cl abundance
                        abunda[abunda == inf] =  0
                        abunda=np.nan_to_num(abunda)
                        abunda = [i2 for i2 in abunda if i2 != 0]
                        abunda = [i2 for i2 in abunda if i2 < elem_abun_DIMS.Cl[i]*3 and i2>elem_abun_DIMS.Cl[i]*0.3]
                ...
                if (Cl3_ab!=0 and Cl2_ab!=0 and Cl4_ab!=0):
                    if ((He3_ab/(He2_ab+He3_ab))>=0 and (He3_ab/(He2_ab+He3_ab))<=1):
                        elem_abun_DIMS.Cl[i]= icf.getElemAbundance(atom_abun, icf_list=['DIMS14_12','DIMS14_32']).get("DIMS14_32") # Computes the Cl abundance
                        abunda = icf.getElemAbundance(atom_abun_fake, icf_list=['DIMS14_12','DIMS14_32']).get("DIMS14_32") # Computes the Cl abundance
                        abunda[abunda == inf] =  0
                        abunda=np.nan_to_num(abunda)
                        abunda = [i2 for i2 in abunda if i2 != 0]
                        abunda = [i2 for i2 in abunda if i2 < elem_abun_DIMS.Cl[i]*3 and i2>elem_abun_DIMS.Cl[i]*0.3]
