# ionicabundances_radial_script.py:
...
def ionicabundances(obs,obs_fake,Te,Te_error,Te_fake,Ne,Ne_error,Ne_fake,i,line_names,lines_available,ion_abun,ion_abun_error,param_estimated,param_requered,param_mod_name):
