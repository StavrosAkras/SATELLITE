...
def TeNe(flux_angles,flux_angles_error,dist,line_names,lines_available,param_estimated,param_requered,param_mod_name,param_model_values,par_plotname,par_plotymin,par_plotymax):
    ...
    print >>file6, "Dist",'He      ', 'N_KB    ','ICF(N)_KB','N_DI    ','ICF(N)_DI', 'O_KB    ','ICF(O)_KB', 'O_DI    ','ICF(O)_DI','S_KB    ', 'ICF(S)_KB','S_DI    ','ICF(S)_DI','Ne_KB  ','ICF(Ne)_KB','Ne_DI  ','ICF(Ne)_DI','Cl_KB  ','ICF(Cl)_KB','Cl_DI  ','ICF(Cl)_DI','Ar_KB ','ICF(Ar)_KB','Ar_DI   ','ICF(Ar)_DI','NO_ratio_KB','NO_ratio_DIMS','SO_ratio_KB','SO_ratio_DIMS','NeO_ratio_KB','NeO_ratio_DIMS','ClO_ratio_KB','ClO_ratio_DIMS','ArO_ratio_KB','ArO_ratio_DIMS'      
      
    
    file5 = open('PyNeb_output_ionic_abund_radial.txt','w')
    print >>file5, "Dist",'He+(5876)','He+(6678)','He++(4686)','He++(5412)','N0(5199)','N+(5755)','N+(6548)','N+(6584)','O0(5577)','O0(6300)','O0(6363)','O+(3727)','O+(3729)','O+(7320)','O+(7330)','O+++(4363)','O+++(4959)','O+++(5007)','S+(6716)  ','S+(6731)','S++(6312)','S++(9069)','Ne++(3868)','Ne++(3968)','Cl++(5518)', 'Cl++(5538)','Ar++(7136)','Ar+++(4712)', 'Ar+++(4740)'  

    
    file4 = open('PyNeb_output_Te_and_Ne_radial.txt','w')
    print >>file4, "Dist","Te_NII","Ne_SII ","Te_OI","Ne_SII","Te_OII","Ne_SII","Te_OIII","Ne_SII","Te_SIII","Ne_SII","Te_OII","Ne_OII","Te_NII","Ne_OII","Te_OI ","Ne_OII","Te_OIII","Ne_ClIII","Te_SIII","Ne_ClIII","Te_OIII","Ne_ArVI","Te_SIII","Ne_ArVI","Te_NII","Ne_ClIII"
...
#    minn=12
    ...
    for i in range(0,minn):
        ...
        print >>file4, "######################################"," Distance from centrar star  ", i ," ##############################"
        print >>file5, "######################################"," Distance from centrar star  ", i ," ##############################"
        print >>file6, "######################################"," Distance from centrar star  ", i ," ##############################"
...
#           print >>file3, "H1r_6563Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "H1r_6563A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "H1r_4861Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "H1r_4861A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "H1r_4341Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "H1r_4341A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "H1r_4102Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "H1r_4102A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "He2r_4686Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "He2r_4686A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "He2r_5411Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "He2r_5411A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "He1r_5876Ae", '{:03.3f}'.format(error)        
            ...
            print >>file3, "He1r_5876A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "He1r_6678Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "He1r_6678A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "S2_6716Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "S2_6716A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "S2_6731Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "S2_6731A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "S3_6312Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "S3_6312A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "S3_9069Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "S3_9069A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "N1_5200Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "N1_5200A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "N2_5755Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "N2_5755A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "N2_6548Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "N2_6548A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "N2_6584Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "N2_6584A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O1_5577Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O1_5577A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O1_6300Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O1_6300A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O1_6364Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O1_6364A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O2_3726Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O2_3726A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O2_3729Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O2_3729A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O2_7319A+e", '{:03.3f}'.format(error)
            ...
            print >>file3, "O2_7319A+", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O2_7330A+e", '{:03.3f}'.format(error)
            ...
            print >>file3, "O2_7330A+", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O3_4363Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O3_4363A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#            print >>file3, "O3_4959Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O3_4959A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "O3_5007Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "O3_5007A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#            print >>file3, "Cl3_5518Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "Cl3_5518A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Cl3_5538Ae", '{:03.3f}'.format(error)        
            ...
            print >>file3, "Cl3_5538A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Ne3_3869Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "Ne3_3869A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Ne3_3968Ae", '{:03.3f}'.format(error)                
            ...
            print >>file3, "Ne3_3968A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Ar3_7136Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "Ar3_7136A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Ar4_4711Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "Ar4_4711A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#           print >>file3, "Ar4_4740Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "Ar4_4740A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#            print >>file3, "C1_8728Ae", '{:03.3f}'.format(error)
            ...
            print >>file3, "C1_8728A", '{:03.3f}'.format(0),'{:03.3f}'.format(0)
...
#        print , "PyNeb: cH(b)=",obs.extinction.cHbeta[0],"+-",obs.extinction.cHbeta[1] 
        print >>file10, "PyNeb: cH(b) = {:.2f} +/- {:.2f}".format(obs.extinction.cHbeta[0],np.std(obs_fake.extinction.cHbeta))
        print >>file10, "PyNeb: E(B-V) = {:.2f} +/- {:.2f}".format(obs.extinction.E_BV[0],np.std(obs_fake.extinction.E_BV))
...
#        plt.show()
        ...
        if (index_Te_NII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (NII-SII): Te_NII  = {0:5.0f}, Ne_SII = {1:7.1f}  cm-1'.format(Te.NIISII[i], Ne.NIISII[i])
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OI-SII): Te_OI  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OISII[i],Ne.OISII[i])
        ...
        if (index_Te_OII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OII-SII): Te_OII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIISII[i], Ne.OIISII[i])
        ...
        if (index_Te_OIII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-SII): Te_OIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIIISII[i], Ne.OIIISII[i])
        ...
        if (index_Te_SIII=="yes" and index_Ne_SII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-SII): Te_SIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.SIIISII[i], Ne.SIIISII[i])
        ...
        if (index_Te_OII=="yes" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OII-OII): Te_OII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIIOII[i], Ne.OIIOII[i])
        ...
        if (index_Te_NII=="yes" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (NII-OII): Te_NII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.NIIOII[i],Ne.NIIOII[i])
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_OII=="yes"):
            ...
            print >>file10, 'PyNeb: low zones (OI-OII): Te_OI  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIOII[i], Ne.OIOII[i])
        ...
        if (index_Te_OIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-ClIII): Te_OIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.OIIIClIII[i],Ne.OIIIClIII[i])        
        ...
        if (index_Te_SIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-ClIII): Te_SIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.SIIIClIII[i], Ne.SIIIClIII[i])
        ...
        if (index_Te_OIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (OIII-ArVI): Te_OIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.OIIIArVI[i], Ne.OIIIArVI[i])          
        ...
        if (index_Te_SIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print >>file10, 'PyNeb: medium zones (SIII-ArVI): Te_SIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.SIIIArVI[i],Ne.SIIIArVI[i])
