# TeNe_radial_script.py:
# Computes c(Hb), Te and Ne parameters for each radial distance in a pseudo-slit with specific width, length and PA using the PyNeb package (Luridiana et al. 2015) 
# as well as the ionic/elemental abundances and ICFs.
# The routine returns plots for all these parameters as a function of the radial distance.
# The results are also provided in an ascii file (PyNeb_output_total_abund_ICFs_radial.txt 
...
def TeNe(flux_angles,flux_angles_error,dist,line_names,lines_available,param_estimated,param_requered,param_mod_name,param_model_values,par_plotname,par_plotymin,par_plotymax):
    ...
    file6 = open('PyNeb_output_total_abund_ICFs_radial.txt','w')
    print("Dist",'He      ', 'N_KB    ','ICF(N)_KB','N_DI    ','ICF(N)_DI', 'O_KB    ','ICF(O)_KB', 'O_DI    ','ICF(O)_DI','S_KB    ', 'ICF(S)_KB','S_DI    ','ICF(S)_DI','Ne_KB  ','ICF(Ne)_KB','Ne_DI  ','ICF(Ne)_DI','Cl_KB  ','ICF(Cl)_KB','Cl_DI  ','ICF(Cl)_DI','Ar_KB ','ICF(Ar)_KB','Ar_DI   ','ICF(Ar)_DI','NO_ratio_KB','NO_ratio_DIMS','SO_ratio_KB','SO_ratio_DIMS','NeO_ratio_KB','NeO_ratio_DIMS','ClO_ratio_KB','ClO_ratio_DIMS','ArO_ratio_KB','ArO_ratio_DIMS', file=file6)      
      
    
    file5 = open('PyNeb_output_ionic_abund_radial.txt','w')
    print("Dist",'He+(5876)','He+(6678)','He++(4686)','He++(5412)','N0(5199)','N+(5755)','N+(6548)','N+(6584)','O0(5577)','O0(6300)','O0(6363)','O+(3727)','O+(3729)','O+(7320)','O+(7330)','O+++(4363)','O+++(4959)','O+++(5007)','S+(6716)  ','S+(6731)','S++(6312)','S++(9069)','Ne++(3868)','Ne++(3968)','Cl++(5518)', 'Cl++(5538)','Ar++(7136)','Ar+++(4712)', 'Ar+++(4740)', file=file5)  

    
    file4 = open('PyNeb_output_Te_and_Ne_radial.txt','w')
    print("Dist","Te_NII","Ne_SII ","Te_OI","Ne_SII","Te_OII","Ne_SII","Te_OIII","Ne_SII","Te_SIII","Ne_SII","Te_OII","Ne_OII","Te_NII","Ne_OII","Te_OI ","Ne_OII","Te_OIII","Ne_ClIII","Te_SIII","Ne_ClIII","Te_OIII","Ne_ArVI","Te_SIII","Ne_ArVI","Te_NII","Ne_ClIII", file=file4)
    
    radial_length=[len(flux_angles.Ha_6563),len(flux_angles.Hb_4861),len(flux_angles.Hg_4340),len(flux_angles.Hd_4101),len(flux_angles.SIIa_6716),len(flux_angles.SIIb_6731),len(flux_angles.SIIIa_6312),len(flux_angles.SIIIb_9069),len(flux_angles.NIIa_5755),len(flux_angles.NIIb_6548),len(flux_angles.NIIc_6584),len(flux_angles.OIIIa_4363),len(flux_angles.OIIIb_4959),len(flux_angles.OIIIc_5007),len(flux_angles.OIIa_3727),len(flux_angles.OIIb_3729),len(flux_angles.OIIc_7320),len(flux_angles.OIId_7330),len(flux_angles.HeIa_5876),len(flux_angles.HeIb_6678),len(flux_angles.HeIIa_4686),len(flux_angles.HeIIb_5412),len(flux_angles.OIa_5577),len(flux_angles.OIb_6300),len(flux_angles.OIc_6363),len(flux_angles.NI_5199),len(flux_angles.ArIVa_4712),len(flux_angles.ArIVb_4740),len(flux_angles.ClIIIa_5517),len(flux_angles.ClIIIb_5538),len(flux_angles.NeIIIa_3868),len(flux_angles.NeIIIb_3967),len(flux_angles.ArIII_7136),len(flux_angles.CI_8727)]
...
#    minn=12
    ...
    for i in range(0,minn):
        ...
        print("######################################"," Distance from centrar star  ", i ," ##############################", file=file4)
        print("######################################"," Distance from centrar star  ", i ," ##############################", file=file5)
        print("######################################"," Distance from centrar star  ", i ," ##############################", file=file6)
        
            
        file3 = open('test.dat','w')
        print("LINE test err", file=file3)

        if len(flux_angles.Ha_6563)!=0 and flux_angles.Hb_4861[i]!=0 :
...
#           print >>file3, "H1r_6563Ae", '{:03.3f}'.format(error)
            ...
            print("H1r_6563A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.Hb_4861)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "H1r_4861Ae", '{:03.3f}'.format(error)
            ...
            print("H1r_4861A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.Hg_4340)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "H1r_4341Ae", '{:03.3f}'.format(error)
            ...
            print("H1r_4341A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.Hd_4101)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "H1r_4102Ae", '{:03.3f}'.format(error)
            ...
            print("H1r_4102A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.HeIIa_4686)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "He2r_4686Ae", '{:03.3f}'.format(error)
            ...
            print("He2r_4686A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.HeIIb_5412)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "He2r_5411Ae", '{:03.3f}'.format(error)
            ...
            print("He2r_5411A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.HeIa_5876)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "He1r_5876Ae", '{:03.3f}'.format(error)        
            ...
            print("He1r_5876A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.HeIb_6678)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "He1r_6678Ae", '{:03.3f}'.format(error)
            ...
            print("He1r_6678A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.SIIa_6716)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "S2_6716Ae", '{:03.3f}'.format(error)
            ...
            print("S2_6716A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.SIIb_6731)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "S2_6731Ae", '{:03.3f}'.format(error)
            ...
            print("S2_6731A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.SIIIa_6312)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "S3_6312Ae", '{:03.3f}'.format(error)
            ...
            print("S3_6312A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
        
        if len(flux_angles.SIIIb_9069)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "S3_9069Ae", '{:03.3f}'.format(error)
            ...
            print("S3_9069A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NI_5199)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "N1_5200Ae", '{:03.3f}'.format(error)
            ...
            print("N1_5200A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NIIa_5755)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "N2_5755Ae", '{:03.3f}'.format(error)
            ...
            print("N2_5755A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NIIb_6548)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "N2_6548Ae", '{:03.3f}'.format(error)
            ...
            print("N2_6548A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NIIc_6584)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "N2_6584Ae", '{:03.3f}'.format(error)
            ...
            print("N2_6584A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIa_5577)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O1_5577Ae", '{:03.3f}'.format(error)
            ...
            print("O1_5577A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIb_6300)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O1_6300Ae", '{:03.3f}'.format(error)
            ...
            print("O1_6300A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIc_6363)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O1_6364Ae", '{:03.3f}'.format(error)
            ...
            print("O1_6364A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIa_3727)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O2_3726Ae", '{:03.3f}'.format(error)
            ...
            print("O2_3726A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIb_3729)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O2_3729Ae", '{:03.3f}'.format(error)
            ...
            print("O2_3729A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIc_7320)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O2_7319A+e", '{:03.3f}'.format(error)
            ...
            print("O2_7319A+", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIId_7330)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O2_7330A+e", '{:03.3f}'.format(error)
            ...
            print("O2_7330A+", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIIa_4363)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O3_4363Ae", '{:03.3f}'.format(error)
            ...
            print("O3_4363A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIIb_4959)!=0 and flux_angles.Hb_4861[i]!=0:
...
#            print >>file3, "O3_4959Ae", '{:03.3f}'.format(error)
            ...
            print("O3_4959A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.OIIIc_5007)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "O3_5007Ae", '{:03.3f}'.format(error)
            ...
            print("O3_5007A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.ClIIIa_5517)!=0 and flux_angles.Hb_4861[i]!=0:
...
#            print >>file3, "Cl3_5518Ae", '{:03.3f}'.format(error)
            ...
            print("Cl3_5518A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.ClIIIb_5538)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Cl3_5538Ae", '{:03.3f}'.format(error)        
            ...
            print("Cl3_5538A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NeIIIa_3868)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Ne3_3869Ae", '{:03.3f}'.format(error)
            ...
            print("Ne3_3869A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.NeIIIb_3967)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Ne3_3968Ae", '{:03.3f}'.format(error)                
            ...
            print("Ne3_3968A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.ArIII_7136)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Ar3_7136Ae", '{:03.3f}'.format(error)
            ...
            print("Ar3_7136A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.ArIVa_4712)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Ar4_4711Ae", '{:03.3f}'.format(error)
            ...
            print("Ar4_4711A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.ArIVb_4740)!=0 and flux_angles.Hb_4861[i]!=0:
...
#           print >>file3, "Ar4_4740Ae", '{:03.3f}'.format(error)
            ...
            print("Ar4_4740A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
            
        if len(flux_angles.CI_8727)!=0 and flux_angles.Hb_4861[i]!=0:
...
#            print >>file3, "C1_8728Ae", '{:03.3f}'.format(error)
            ...
            print("C1_8728A", '{:03.3f}'.format(0),'{:03.3f}'.format(0), file=file3)
...
#        print >>file3, "C2_????A", '{:03.3f}'.format(flux_angles.CII_6461[i]*100/flux_angles.Hb_4861[i])
        ...
        print("######################################################################################", file=file10)
        print("######################################################################################", file=file10)
#        print , "PyNeb: cH(b)=",obs.extinction.cHbeta[0],"+-",obs.extinction.cHbeta[1] 
...
#        print >>file10, "PyNeb: E(B-V)=", obs.extinction.E_BV[0],"+-",obs.extinction.E_BV[1] 
...
#        plt.show()
        ...
        if (index_Te_NII=="yes" and index_Ne_SII=="yes"):
            ...
            print('PyNeb: low zones (NII-SII): Te_NII  = {0:5.0f}, Ne_SII = {1:7.1f}  cm-1'.format(Te.NIISII[i], Ne.NIISII[i]), file=file10)
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_SII=="yes"):
            ...
            print('PyNeb: low zones (OI-SII): Te_OI  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OISII[i],Ne.OISII[i]), file=file10)
        ...
        if (index_Te_OII=="yes" and index_Ne_SII=="yes"):
            ...
            print('PyNeb: low zones (OII-SII): Te_OII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIISII[i], Ne.OIISII[i]), file=file10)
        ...
        if (index_Te_OIII=="yes" and index_Ne_SII=="yes"):
            ...
            print('PyNeb: medium zones (OIII-SII): Te_OIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.OIIISII[i], Ne.OIIISII[i]), file=file10)
        ...
        if (index_Te_SIII=="yes" and index_Ne_SII=="yes"):
            ...
            print('PyNeb: medium zones (SIII-SII): Te_SIII  = {0:5.0f},Ne_SII = {1:7.1f}  cm-1'.format(Te.SIIISII[i], Ne.SIIISII[i]), file=file10)
        ...
        if (index_Te_OII=="yes" and index_Ne_OII=="yes"):
            ...
            print('PyNeb: low zones (OII-OII): Te_OII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIIOII[i], Ne.OIIOII[i]), file=file10)
        ...
        if (index_Te_NII=="yes" and index_Ne_OII=="yes"):
            ...
            print('PyNeb: low zones (NII-OII): Te_NII  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.NIIOII[i],Ne.NIIOII[i]), file=file10)
        ...
        if (index_Te_OI=="yes" and index_Te_OI2=="no" and index_Ne_OII=="yes"):
            ...
            print('PyNeb: low zones (OI-OII): Te_OI  = {0:5.0f},Ne_OII = {1:7.1f}  cm-1'.format(Te.OIOII[i], Ne.OIOII[i]), file=file10)
        ...
        if (index_Te_OIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print('PyNeb: medium zones (OIII-ClIII): Te_OIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.OIIIClIII[i],Ne.OIIIClIII[i]), file=file10)        
        ...
        if (index_Te_SIII=="yes" and index_Ne_ClIII=="yes"):
            ...
            print('PyNeb: medium zones (SIII-ClIII): Te_SIII  = {0:5.0f},Ne_ClIII = {1:7.1f}  cm-1'.format(Te.SIIIClIII[i], Ne.SIIIClIII[i]), file=file10)
        ...
        if (index_Te_OIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print('PyNeb: medium zones (OIII-ArVI): Te_OIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.OIIIArVI[i], Ne.OIIIArVI[i]), file=file10)          
        ...
        if (index_Te_SIII=="yes" and index_Ne_ArVI=="yes"):
            ...
            print('PyNeb: medium zones (SIII-ArVI): Te_SIII  = {0:5.0f},Ne_ArVI = {1:7.1f}  cm-1'.format(Te.SIIIArVI[i],Ne.SIIIArVI[i]), file=file10)
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        plt.errorbar(dist2,Te.NIISII,yerr=Te_error.NIISII,label="Te ([N II])")
        plt.errorbar(dist2,Ne.NIISII,yerr=Ne_error.NIISII,label="Ne ([S II])")
        ...
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(SII6716_31)_both_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(SII6716_31)_both_radial.pdf")    
#        plt.show()
...
# Te plot    
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.NIISII,yerr=Te_error.NIISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(SII6716_31)_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(SII6716_31)_radial.pdf")    
...
# Ne plot    
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.NIISII,yerr=Ne_error.NIISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(NII6548_84)_radial.png")
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(NII6548_84)_radial.pdf")    
...
# Te and Ne plot
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OISII,yerr=Te_error.OISII,label="Te ([O I])")
        plt.errorbar(dist2,Ne.OISII,yerr=Ne_error.OISII,label="Ne ([S II])")
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OI6300_63)_Ne(SII6716_31)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OI6300_63)_Ne(SII6716_31)_both_radial.pdf")   
...
# Te plot
    ...
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OISII,yerr=Te_error.OISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OI6300_63)_only_Ne(SII6716_31)_radial.png")
        fig.savefig("output_radial_plots/Te(OI6300_63)_only_Ne(SII6716_31)_radial.pdf")   
...
# Ne plot
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OISII,yerr=Ne_error.OISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[S II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OI6300_63)_radial.png")
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OI6300_63)_radial.pdf")   
...
# Te and Ne plot        
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIISII,yerr=Te_error.OIISII,label="Te ([O II])")
        plt.errorbar(dist2,Ne.OIISII,yerr=Ne_error.OIISII,label="Ne ([S II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_Ne(SII6716_31)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_Ne(SII6716_31)_both_radial.pdf")
#        plt.show() 
...
# Te plot        
    ...
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIISII,yerr=Te_error.OIISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(SII6716_31)_radial.png")
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(SII6716_31)_radial.pdf")
...
# Ne plot        
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIISII,yerr=Ne_error.OIISII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[S II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OII3727_29_7320_30)_radial.png")
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OII3727_29_7320_30)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIISII,yerr=Te_error.OIIISII,label="Te ([O III])")
        plt.errorbar(dist2,Ne.OIIISII,yerr=Ne_error.OIIISII,label="Ne ([S II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(SII6716_31)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(SII6716_31)_both_radial.pdf")
#        plt.show()     
...
# Te plot    
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIISII,yerr=Te_error.OIIISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(SII6716_31)_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(SII6716_31)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIIISII,yerr=Ne_error.OIIISII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[S II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OIII4959_5007)_radial.png")
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(OIII4959_5007)_radial.pdf")
...
# Te and Ne plot
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIISII,yerr=Te_error.SIIISII,label="Te ([S III])")
        plt.errorbar(dist2,Ne.SIIISII,yerr=Ne_error.SIIISII,label="Ne ([S II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(SII6716_31)_both_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(SII6716_31)_both_radial.pdf")
#        plt.show() 
...
# Te plot
    ...
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIISII,yerr=Te_error.SIIISII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(SII6716_31)_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(SII6716_31)_radial.pdf")
...
# Ne plot
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.SIIISII,yerr=Ne_error.SIIISII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[S II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(SIII6312_9069)_radial.png")
        fig.savefig("output_radial_plots/Ne(SII6716_31)_only_Te(SIII6312_9069)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIOII,yerr=Te_error.OIIOII,label="Te ([O II])")
        plt.errorbar(dist2,Ne.OIIOII,yerr=Ne_error.OIIOII,label="Ne ([O II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_Ne(OII3727_29)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_Ne(OII3727_29)_both_radial.pdf")
#        plt.show() 
...
# Te  plot    
    ...
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIOII,yerr=Te_error.OIIOII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[O II] (K) ",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(OII3727_29)_radial.png")
        fig.savefig("output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(OII3727_29)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIIOII,yerr=Ne_error.OIIOII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(OII3727_29_7320_30)_radial.png")
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(OII3727_29_7320_30)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.NIIOII,yerr=Te_error.NIIOII,label="Te ([N II])")
        plt.errorbar(dist2,Ne.NIIOII,yerr=Ne_error.NIIOII,label="Ne ([O II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(OII3727_29)_both_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(OII3727_29)_both_radial.pdf")
#        plt.show() 
...
# Te plot    
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.NIIOII,yerr=Te_error.NIIOII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[N II] (K)",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(OII3727_29)_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(OII3727_29)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.NIIOII,yerr=Ne_error.NIIOII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[O II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(NII6548_84)_radial.png")
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(NII6548_84)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIOII,yerr=Te_error.OIOII,label="Te ([O I])")
        plt.errorbar(dist2,Ne.OIOII,yerr=Ne_error.OIOII,label="Ne ([O II])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OI6300_63)_Ne(OII3727_29)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OI6300_63)_Ne(OII3727_29)_both_radial.pdf")
#        plt.show() 
...
# Te plot    
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIOII,yerr=Te_error.OIOII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[O I] (K) ",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OI6300_63)_only_Ne(OII3727_29)_radial.png")
        fig.savefig("output_radial_plots/Te(OI6300_63)_only_Ne(OII3727_29)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIOII,yerr=Ne_error.OIOII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[O II] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(OI6300_63)_radial.png")
        fig.savefig("output_radial_plots/Ne(OII3727_29)_only_Te(OI6300_63)_radial.pdf")
...
# Te and Ne plot 
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIIClIII,yerr=Te_error.OIIIClIII,label="Te ([O III])")
        plt.errorbar(dist2,Ne.OIIIClIII,yerr=Ne_error.OIIIClIII,label="Ne ([Cl III])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(ClIII5517_38)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(ClIII5517_38)_both_radial.pdf")
#        plt.show() 
...
# Te plot 
    ...
    if param_requered[index_line1]=="yes":
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIIClIII,yerr=Te_error.OIIIClIII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[O III] (K) ",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(ClIII5517_38)_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(ClIII5517_38)_radial.pdf")
...
# Ne plot 
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIIIClIII,yerr=Ne_error.OIIIClIII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(OIII4959_5007)_radial.png")
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(OIII4959_5007)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIIClIII,yerr=Te_error.SIIIClIII,label="Te ([S III])")
        plt.errorbar(dist2,Ne.SIIIClIII,yerr=Ne_error.SIIIClIII,label="Ne ([Cl III])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(ClIII5517_38)_both_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(ClIII5517_38)_both_radial.pdf")
#        plt.show() 
...
# Te plot    
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIIClIII,yerr=Te_error.SIIIClIII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[S III] (K)",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(ClIII5517_38)_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(ClIII5517_38)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.SIIIClIII,yerr=Ne_error.SIIIClIII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[Cl III] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(SIII6312_9069)_radial.png")
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(SIII6312_9069)_radial.pdf")
...
# Te and Ne plot    
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIIArVI,yerr=Te_error.OIIIArVI,label="Te ([O III])")
        plt.errorbar(dist2,Ne.OIIIArVI,yerr=Ne_error.OIIIArVI,label="Ne ([Ar VI])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(ArVI4712_40)_both_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_Ne(ArVI4712_40)_both_radial.pdf")
#        plt.show() 
...
# Te  plot    
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.OIIIArVI,yerr=Te_error.OIIIArVI)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[O III] (K) ",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(ArVI4712_40)_radial.png")
        fig.savefig("output_radial_plots/Te(OIII4959_5007)_only_Ne(ArVI4712_40)_radial.pdf")
...
# Ne plot    
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.OIIIArVI,yerr=Ne_error.OIIIArVI)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        ...
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(ArVI4712_40)_only_Te(OIII4959_5007)_radial.png")
        fig.savefig("output_radial_plots/Ne(ArVI4712_40)_only_Te(OIII4959_5007)_radial.pdf")
...
# Te and Ne plot  
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIIArVI,yerr=Te_error.SIIIArVI,label="Te ([S III])")
        plt.errorbar(dist2,Ne.SIIIArVI,yerr=Ne_error.SIIIArVI,label="Ne ([Ar VI])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(ArVI4712_40)_both_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_Ne(ArVI4712_40)_both_radial.pdf")
#        plt.show()
...
# Te plot  
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.SIIIArVI,yerr=Te_error.SIIIArVI)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[S III] (K)",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(ArVI4712_40)_radial.png")
        fig.savefig("output_radial_plots/Te(SIII6312_9069)_only_Ne(ArVI4712_40)_radial.pdf")
...
# Ne plot  
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.SIIIArVI,yerr=Ne_error.SIIIArVI)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[Ar VI] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(ArVI4712_40)_only_Te(SIII6312_9069)_radial.png")
        fig.savefig("output_radial_plots/Ne(ArVI4712_40)_only_Te(SIII6312_9069)_radial.pdf")
...
# Te and Ne plot 
    ...
    if param_requered[index_line1]=="yes" or param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.NIIClIII,yerr=Te_error.NIIClIII,label="Te ([N II])")
        plt.errorbar(dist2,Ne.NIIClIII,yerr=Ne_error.NIIClIII,label="Ne ([Cl III])")  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ...
        plt.legend(loc='upper right',prop={'size':18})
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(ClIII5517_38)_both_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_Ne(ClIII5517_38)_both_radial.pdf")
#        plt.show()
...
# Te plot 
    ...
    if param_requered[index_line1]=="yes" :
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Te.NIIClIII,yerr=Te_error.NIIClIII)
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel("Te[N II] (K)",fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(ClIII5517_38)_radial.png")
        fig.savefig("output_radial_plots/Te(NII6548_84)_only_Ne(ClIII5517_38)_radial.pdf")
...
# Ne plot 
    ...
    if param_requered[index_line2]=='yes':
        ...
        fig,ax1=plt.subplots(figsize=(12,7))
        plt.errorbar(dist2,Ne.NIIClIII,yerr=Ne_error.NIIClIII)  
        plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
        plt.ylabel(r'Ne[Cl III] (cm$^{-3}$)',fontsize=21,labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ax1.tick_params(axis='y', labelsize=21, pad=6)
        ax1.yaxis.get_offset_text().set_fontsize(18)
        plt.ylim(ymin,ymax)
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(NII6548_84)_radial.png")
        fig.savefig("output_radial_plots/Ne(ClIII5517_38)_only_Te(NII6548_84)_radial.pdf")
...
#############################################################################################
    ...
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.He,yerr=elem_abun_KB_error.He,label="He (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.He,yerr=elem_abun_DIMS_error.He,label="He (DIMS)")
    index_line1=line_names.index("HeI_5876s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.HeIa,yerr=ion_abun_error.HeIa,label="He+ 5876")
    index_line1=line_names.index("HeI_6678s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.HeIb,yerr=ion_abun_error.HeIb,label="He+ 6678")
    index_line1=line_names.index("HeII_4686s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.HeIIa,yerr=ion_abun_error.HeIIa,label="He++ 4686")
    index_line1=line_names.index("HeII_5412s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.HeIIb,yerr=ion_abun_error.HeIIb,label="He++ 5412")
    ...
    plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
    plt.ylabel("Ionic and Total abundances ",fontsize=21,labelpad=6)
    ax1.tick_params(axis='x', labelsize=21, pad=6)
    ax1.tick_params(axis='y', labelsize=21, pad=6)
    ax1.yaxis.get_offset_text().set_fontsize(18)
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/He_abundances_radial.png")
    fig.savefig("output_radial_plots/He_abundances_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.O,yerr=elem_abun_KB_error.O,label="O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.O,yerr=elem_abun_DIMS_error.O,label="O (DIMS)")
    index_line1=line_names.index("O3_4363s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIIIa,yerr=ion_abun_error.OIIIa,label="O++ 4363")
    index_line1=line_names.index("O3_5007s")
    index_line2=line_names.index("O3_4959s")
    if lines_available[index_line1]=="yes" and lines_available[index_line2]=="yes": 
        plt.errorbar(dist2,ion_abun.OIIIc,yerr=ion_abun_error.OIIIc,label="O++ 5007")
    ...
    if lines_available[index_line1]=="no" and lines_available[index_line2]=="yes": 
        plt.errorbar(dist2,ion_abun.OIIIb,yerr=ion_abun_error.OIIIb,label="O++ 4959")
    ...
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    plt.ylim(ymin,ymax)
    fig.savefig("output_radial_plots/O_abundances_radial_a.png")
    fig.savefig("output_radial_plots/O_abundances_radial_a.pdf")
    #plt.show()
...
#############################################################################################
    ...
    plt.errorbar(dist2,elem_abun_DIMS.O,yerr=elem_abun_DIMS_error.O,label="O (DIMS)")
    index_line1=line_names.index("O2_3727s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIIa,yerr=ion_abun_error.OIIa,label="O+ 3727")
    index_line1=line_names.index("O2_3729s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIIb,yerr=ion_abun_error.OIIb,label="O+ 3729")
    index_line1=line_names.index("O2_7320s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIIc,yerr=ion_abun_error.OIIc,label="O+ 7320")
    index_line1=line_names.index("O2_7330s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIId,yerr=ion_abun_error.OIId,label="O+ 7330")
    index_line1=line_names.index("O1_5577s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.OIa,yerr=ion_abun_error.OIa,label="Oo 5577")
    ...
    if lines_available[index_line1]=="yes" and lines_available[index_line2]=="yes": 
        plt.errorbar(dist2,ion_abun.OIb,yerr=ion_abun_error.OIb,label="Oo 6300")
    if lines_available[index_line1]=="yes" and lines_available[index_line2]=="no": 
        plt.errorbar(dist2,ion_abun.OIb,yerr=ion_abun_error.OIb,label="Oo 6300")
    if lines_available[index_line1]=="no" and lines_available[index_line2]=="yes": 
        plt.errorbar(dist2,ion_abun.OIc,yerr=ion_abun_error.OIc,label="Oo 6363")
    ...
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    plt.ylim(ymin,ymax)
    fig.savefig("output_radial_plots/O_abundances_radial_b.png")
    fig.savefig("output_radial_plots/O_abundances_radial_b.pdf")
    #plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.N,yerr=elem_abun_KB_error.N,label="N (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.N,yerr=elem_abun_DIMS_error.N,label="N (DIMS)")
    index_line1=line_names.index("N1_5199s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.NI,yerr=ion_abun_error.NI,label="No 5199")
    index_line1=line_names.index("N2_5755s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.NIIa,yerr=ion_abun_error.NIIa,label="N+ 5755")

    index_line1=line_names.index("N2_6548s")
    index_line2=line_names.index("N2_6583s")
    if lines_available[index_line1]=="yes" and lines_available[index_line2]=="yes":
        plt.errorbar(dist2,ion_abun.NIIc,yerr=ion_abun_error.NIIc,label="N+ 6584")
    if lines_available[index_line1]=="no" and lines_available[index_line2]=="yes":
        plt.errorbar(dist2,ion_abun.NIIc,yerr=ion_abun_error.NIIc,label="N+ 6584")
    if lines_available[index_line1]=="yes" and lines_available[index_line2]=="no":
        plt.errorbar(dist2,ion_abun.NIIb,yerr=ion_abun_error.NIIb,label="N+ 6548")
    ...
    plt.errorbar(dist2,ion_abun.NI,yerr=ion_abun_error.NI,label="No 5199")
    plt.xlabel("Distance from CS (arcsec)",fontsize=21,labelpad=6)
    plt.ylabel("Ionic and Total abundances ",fontsize=21,labelpad=6)
    ax1.ticklabel_format(style='sci',scilimits=(-3,4),axis='both')
    ax1.tick_params(axis='x', labelsize=21, pad=6)
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/N_abundances_radial.png")
    fig.savefig("output_radial_plots/N_abundances_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.S,yerr=elem_abun_KB_error.S,label="S (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.S,yerr=elem_abun_DIMS_error.S,label="S (DIMS)")
    index_line1=line_names.index("S2_6716s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.SIIa,yerr=ion_abun_error.SIIa,label="S+ 6716")
    index_line1=line_names.index("S2_6731s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.SIIb,yerr=ion_abun_error.SIIb,label="S+ 6731")
    index_line1=line_names.index("S3_6312s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.SIIIa,yerr=ion_abun_error.SIIIa,label="S++ 6312")
    index_line1=line_names.index("S3_9069s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.SIIIb,yerr=ion_abun_error.SIIIb,label="S++ 9069")
    ...
    plt.legend(loc='upper right',ncol=3,prop={'size':18}) 
    plt.ylim(ymin,ymax)
    fig.savefig("output_radial_plots/S_abundances_radial.png")
    fig.savefig("output_radial_plots/S_abundances_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.Ne,yerr=elem_abun_KB_error.Ne,label="Ne (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.Ne,yerr=elem_abun_DIMS_error.Ne,label="Ne (DIMS)")
    index_line1=line_names.index("Ne3_3868s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.NeIIIa,yerr=ion_abun_error.NeIIIa,label="Ne++ 3868")
    index_line1=line_names.index("Ne3_3967s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.NeIIIb,yerr=ion_abun_error.NeIIIb,label="Ne++ 3967")
    ...
    fig.savefig("output_radial_plots/Ne_abundances_radial.png")
    fig.savefig("output_radial_plots/Ne_abundances_radial.pdf")
#        plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.Cl,yerr=elem_abun_KB_error.Cl,label="Cl (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.Cl,yerr=elem_abun_DIMS_error.Cl,label="Cl (DIMS)")
    index_line1=line_names.index("Cl3_5517s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.ClIIIa,yerr=ion_abun_error.ClIIIa,label="Cl++ 5517")
    index_line1=line_names.index("Cl3_5538s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.ClIIIb,yerr=ion_abun_error.ClIIIb,label="Cl++ 5538")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=2,prop={'size':18})
    fig.savefig("output_radial_plots/Cl_abundances_radial.png")
    fig.savefig("output_radial_plots/Cl_abundances_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB.Ar,yerr=elem_abun_KB_error.Ar,label="Ar (KB)")
    plt.errorbar(dist2,elem_abun_DIMS.Ar,yerr=elem_abun_DIMS_error.Ar,label="Ar (DIMS)")
    index_line1=line_names.index("Ar3_7136s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.ArIII,yerr=ion_abun_error.ArIII,label="Ar++ 7136")
    index_line1=line_names.index("Ar4_4712s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.ArIVa,yerr=ion_abun_error.ArIVa,label="Ar+++ 4712")
    index_line1=line_names.index("Ar4_4740s")
    if lines_available[index_line1]=="yes": plt.errorbar(dist2,ion_abun.ArIVb,yerr=ion_abun_error.ArIVb,label="Ar+++ 4740")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=2,prop={'size':18})
    fig.savefig("output_radial_plots/Ar_abundances_radial.png")
    fig.savefig("output_radial_plots/Ar_abundances_radial.pdf")
#       plt.show()
...
#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB_ratio.NO,yerr=elem_abun_KB_ratio_error.NO,label="N/O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS_ratio.NO,yerr=elem_abun_DIMS_ratio_error.NO,label="N/O (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/NO_abundances_ratio_radial.png")
    fig.savefig("output_radial_plots/NO_abundances_ratio_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB_ratio.SO,yerr=elem_abun_KB_ratio_error.SO,label="S/O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS_ratio.SO,yerr=elem_abun_DIMS_ratio_error.SO,label="S/O (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/SO_abundances_ratio_radial.png")
    fig.savefig("output_radial_plots/SO_abundances_ratio_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB_ratio.NeO,yerr=elem_abun_KB_ratio_error.NeO,label="Ne/O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS_ratio.NeO,yerr=elem_abun_DIMS_ratio_error.NeO,label="Ne/O (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/NeO_abundances_ratio_radial.png")
    fig.savefig("output_radial_plots/NeO_abundances_ratio_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB_ratio.ClO,yerr=elem_abun_KB_ratio_error.ClO,label="Cl/O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS_ratio.ClO,yerr=elem_abun_DIMS_ratio_error.ClO,label="Cl/O (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/ClO_abundances_ratio_radial.png")
    fig.savefig("output_radial_plots/ClO_abundances_ratio_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_abun_KB_ratio.ArO,yerr=elem_abun_KB_ratio_error.ArO,label="Ar/O (KB)")
    plt.errorbar(dist2,elem_abun_DIMS_ratio.ArO,yerr=elem_abun_DIMS_ratio_error.ArO,label="Ar/O (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/ArO_abundances_ratio_radial.png")
    fig.savefig("output_radial_plots/ArO_abundances_ratio_radial.pdf")
#       plt.show()
...
#############################################################################################
    ...
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_ICF_KB.N,yerr=elem_ICF_KB_error.N,label="N_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.N,yerr=elem_ICF_DIMS_error.N,label="N_ICF (DIMS)")
    #plt.errorbar(dist2,elem_ICF_KB.S,yerr=elem_ICF_KB_error.S,label="S_ICF (KB)")
    #plt.errorbar(dist2,elem_ICF_DIMS.S,yerr=elem_ICF_DIMS_error.S,label="S_ICF (DIMS)")
    ...
    plt.legend(loc='upper right',ncol=2,prop={'size':18})
    plt.ylim(ymin,ymax)
    fig.savefig("output_radial_plots/N_ICFs_radial.png")
    fig.savefig("output_radial_plots/N_ICFs_radial.pdf")


#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_ICF_KB.O,yerr=elem_ICF_KB_error.O,label="O_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.O,yerr=elem_ICF_DIMS_error.O,label="O_ICF (DIMS)")
    plt.errorbar(dist2,elem_ICF_KB.S,yerr=elem_ICF_KB_error.S,label="S_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.S,yerr=elem_ICF_DIMS_error.S,label="S_ICF (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=2,prop={'size':18})
    fig.savefig("output_radial_plots/O_S_ICFs_radial.png")
    fig.savefig("output_radial_plots/O_S_ICFs_radial.pdf")
#       plt.show()

#############################################################################################
    fig,ax1=plt.subplots(figsize=(12,7))
    plt.errorbar(dist2,elem_ICF_KB.Cl,yerr=elem_ICF_KB_error.Cl,label="Cl_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.Cl,yerr=elem_ICF_DIMS_error.Cl,label="Cl_ICF (DIMS)")
    plt.errorbar(dist2,elem_ICF_KB.Ne,yerr=elem_ICF_KB_error.Ne,label="Ne_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.Ne,yerr=elem_ICF_DIMS_error.Ne,label="Ne_ICF (DIMS)")
    plt.errorbar(dist2,elem_ICF_KB.Ar,yerr=elem_ICF_KB_error.Ar,label="Ar_ICF (KB)")
    plt.errorbar(dist2,elem_ICF_DIMS.Ar,yerr=elem_ICF_DIMS_error.Ar,label="Ar_ICF (DIMS)")
    ...
    plt.ylim(ymin,ymax)
    plt.legend(loc='upper right',ncol=3,prop={'size':18})
    fig.savefig("output_radial_plots/Ne_Cl_Ar_ICFs_radial.png")
    fig.savefig("output_radial_plots/Ne_Cl_Ar_ICFs_radial.pdf")
